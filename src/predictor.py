...
##############################################################
model_dir = '../../model'
model_path = '../../model/AV_30_con1.h5'
...
def spectrogram_separator(input_spec_mix, input_face_1, input_face_2, output_spec_1, output_spec_2):
    ...
    try:
        ...
        pass   
    np.save('../../tr_np_res/mix_30_con1.npy', spec_mix)
    np.save('../../tr_np_res/pre_1_30_con1.npy', pre_spec_1)
    np.save('../../tr_np_res/pre_2_30_con1.npy', pre_spec_2)
    np.save('../../tr_np_res/tar_1_30_con1.npy', output_spec_1)
    np.save('../../tr_np_res/tar_2_30_con1.npy', output_spec_2)
    ...
    try:
        ...
        pass
    sf.write('../../tr_res/mix_30_con1.wav', sigal_mix, samplerate=PARAS.SR)
    sf.write('../../tr_res/pre_1_30_con1.wav', sigal_pre_1, samplerate=PARAS.SR)
    sf.write('../../tr_res/pre_2_30_con1.wav', sigal_pre_2, samplerate=PARAS.SR)
    sf.write('../../tr_res/tar_1_30_con1.wav', sigal_target_1, samplerate=PARAS.SR)
    sf.write('../../tr_res/tar_2_30_con1.wav', sigal_target_2, samplerate=PARAS.SR)
