...
test_dataset = '../../pre_dataset/audio_video/tr_set.hdf5'
...
def spectrogram_separator(input_spec_mix, input_face_1, input_face_2, output_spec_1, output_spec_2):
    ...
    try:
        os.makedirs('../../tr_np_res_mask/')
    except FileExistsError:
        pass   
    np.save('../../tr_np_res_mask/100_mix.npy', spec_mix)
    np.save('../../tr_np_res_mask/100_pre_1.npy', pre_spec_1)
    np.save('../../tr_np_res_mask/100_pre_2.npy', pre_spec_2)
    np.save('../../tr_np_res_mask/100_tar_1.npy', output_spec_1)
    np.save('../../tr_np_res_mask/100_tar_2.npy', output_spec_2)
    ...
    try:
        os.makedirs('../../tr_res_mask')
    except FileExistsError:
        pass
    sf.write('../../tr_res_mask/100_mix.wav', sigal_mix, samplerate=PARAS.SR)
    sf.write('../../tr_res_mask/100_pre_1.wav', sigal_pre_1, samplerate=PARAS.SR)
    sf.write('../../tr_res_mask/100_pre_2.wav', sigal_pre_2, samplerate=PARAS.SR)
    sf.write('../../tr_res_mask/100_tar_1.wav', sigal_target_1, samplerate=PARAS.SR)
    sf.write('../../tr_res_mask/100_tar_2.wav', sigal_target_2, samplerate=PARAS.SR)
