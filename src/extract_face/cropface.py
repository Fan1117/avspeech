...
faces_folder = '../../../100_download/separated_data/faces'
...
for path in paths:
 ...
 count += 1
 filepath = '../../../100_download/separated_data/faces/'+path+'/box.txt'
 ...
 for i in range(75):
    image = '../../../100_download/separated_data/faces/'+path+'/out'+str(i)+'.jpg'
    try:
