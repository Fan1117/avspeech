...
faces_folder = '../../../new_download/separated_data/faces'
...
for path in paths:
 ...
 for i in range(75):
    image = '../../../new_download/separated_data/faces/'+path+'/out'+str(i)+'.jpg'
    try:
        os.makedirs('../../../new_download/separated_data/faces1/'+path)
