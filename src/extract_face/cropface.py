...
faces_folder = '../../../200_download/separated_data/faces'
...
for path in paths:
 ...
 count += 1
 filepath = '../../../200_download/separated_data/faces/'+path+'/box.txt'
 ...
 for i in range(75):
    image = '../../../200_download/separated_data/faces/'+path+'/out'+str(i)+'.jpg'
    try:
        os.makedirs('../../../200_download/separated_data/faces1/'+path)
    except FileExistsError:
        pass
    crop(image, (int(boxes[i][0]),int(boxes[i][1]), int(boxes[i][2]), int(boxes[i][5])), '../../../200_download/separated_data/faces1/'+path+'/cropped'+str(i)+'.jpg')
