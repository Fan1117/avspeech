...
faces2_folder = '../../../../pre_data/separated_data/faces2'
...
for path in paths:
  ...
  a = np.zeros((75, 512))
  for i in range(75):
    image = cv2.imread('../../../../pre_data/separated_data/faces2/'+path+'/face'+str(i)+'.jpg')
#    gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
  ...
  try:
      os.makedirs('../../../../pre_data/separated_data/nparray')
  except FileExistsError:
      pass
  np.save('../../../../pre_data/separated_data/nparray/'+path+'_facenet.npy',a)
