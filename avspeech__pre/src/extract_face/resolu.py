...
faces1_folder = '../../../../pre_data/separated_data/faces1'
...
for path in paths:  
  ...
  count += 1
  for i in range(75):
   im = cv2.imread('../../../../pre_data/separated_data/faces1/'+path+'/cropped'+str(i)+'.jpg', cv2.IMREAD_UNCHANGED)
   print(im.shape)
   size = (int(64), int(64))
   ...
   try:
       os.makedirs('../../../../pre_data/separated_data/faces2/'+path)
   except FileExistsError:
       pass
   
   
   
   cv2.imwrite( '../../../../pre_data/separated_data/faces2/'+path+'/face'+str(i)+'.jpg', resized);
  # waitKey(0);
