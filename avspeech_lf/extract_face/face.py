...
def main(input_filename, output_filename, max_results,path):
    ...
    for i in range(len(input_filename)):
        with open(input_filename[i], 'rb') as image:
            ...
            try:
                os.makedirs('../../../200_download/separated_data/faces/'+path)
        ...
        with open("../../../200_download/separated_data/faces/"+path+"/box.txt","a") as f:#append mode
           f.write(str(box)+'\n') 
...
frame_folder = '../../../200_download/separated_data/frame'
...
for path in paths:
    ...
    output = []
    for i in range(75):
       input_image.append('../../../200_download/separated_data/frame/'+path+'/'+str(i)+'.jpg')
       output.append('../../../200_download/separated_data/faces/'+path+'/out'+str(i)+'.jpg')
    max_results = 1
