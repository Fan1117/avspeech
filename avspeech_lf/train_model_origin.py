...
tb = TensorBoard(log_dir='./200_tb_logs', histogram_freq=0, batch_size= batch_size,
...
try:
    ...
    pass
AV.save(model_dir + '/200_AV_origin.h5')
...
# save json
with open(history_dir + '/200_history_origin.json', 'w') as fp:
    r = json.dump(history.history, fp, indent=2)

# read json
with open(history_dir + '/200_history_origin.json', 'r') as fp:
